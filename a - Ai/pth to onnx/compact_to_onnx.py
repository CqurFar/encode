...
model = SRVGGNetCompact(
    num_in_ch=3, num_out_ch=3, num_feat=64, num_conv=16, upscale=1, act_type="prelu"
)

state_dict = torch.load(r"C:\Users\Art\Downloads\Progi\All\Encode\ai models\2xInt-LD-AnimeJaNai.pth")
